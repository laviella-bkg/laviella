...
export interface ApiDomoDomo extends Struct.CollectionTypeSchema {
  collectionName: 'domos';
  info: {
    displayName: 'Domo';
    pluralName: 'domos';
    singularName: 'domo';
  ...
  attributes: {
    ...
    capacity: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    checkInTime: Schema.Attribute.String & Schema.Attribute.DefaultTo<'15:00'>;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::domo.domo'> &
      Schema.Attribute.Private;
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    domo: Schema.Attribute.Relation<'manyToOne', 'api::domo.domo'>;
...
export interface ApiSeasonSeason extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    priceMultiplier: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    domo: Schema.Attribute.Relation<'manyToOne', 'api::domo.domo'>;
    guestImage: Schema.Attribute.Media<'images'>;
    guestName: Schema.Attribute.String & Schema.Attribute.Required;
